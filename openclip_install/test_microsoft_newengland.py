...
model, preprocess_train, preprocess_val = open_clip.create_model_and_transforms('hf-hub_microsoft', pretrained='/admin/home-thieme/log/pubmedbert_unlocked_4_layers_40e_aug_multinode_pretrained_2/checkpoints/epoch_32.pt')
